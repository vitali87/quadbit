...
decode-throughput number in this paper -- the Llama crossover here, the
DeepSeek serving sweep (Section 10), and the GLM serving rows (Section
10.1, \texttt{docs/glm\_results.md}) -- is \textbf{decode-only}: the
