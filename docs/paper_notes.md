...
- **KILL, no crossover.** Sparse peak **6781 tok/s** (P=32768, M~768) is *below* dense floor **7589** (P=2048, M~48) — the curves never overlap. Board: P2048 4735/7589 (0.62); P32768 6781/7793 (0.87); P65536 6228 (rolled off −8%)/dense OOM (~7800 flat).
