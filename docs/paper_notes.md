...
- **Re-opens C9.** The MTP KILL (-17.8% on SM120) was driven by each draft step paying the per-layer all-reduce; that cost just fell 4.7x and the fastest published GLM-5.2 stacks use MTP as a win. Rematch wired as `glm_b200 --spec N`.
